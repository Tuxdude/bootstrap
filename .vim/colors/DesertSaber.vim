...
" Based off DesertEx scheme by Mingbai
" Vim color file
...
hi Comment      guifg=DeepSkyBlue2    gui=italic
hi Constant     guifg=salmon         gui=none
hi Identifier   guifg=aquamarine2    gui=none
hi Function     guifg=Skyblue        gui=none
hi Statement    guifg=brown2         gui=bold
hi PreProc      guifg=MediumPurple   gui=none
hi Type         guifg=ForestGreen    gui=bold
hi Special      guifg=SlateBlue2     gui=none
hi Ignore       guifg=grey40         gui=none
hi Todo         guifg=orangered      guibg=yellow2 gui=none

" Added for Custom functions/classnames highlighting
hi cCustomFunc  guifg=SandyBrown     gui=none
hi cCustomClass guifg=chocolate      gui=none
